...
for t in range(len(rx_list)):
    ...
    r_c_semicircle = pat.Wedge(center=(0, 0), r=(static_dia+1.0)/2*pow(2,1.0/6.0), theta1=90, theta2=270, facecolor=[0,0,1,0.5])
    bx.add_patch(semicircle)
    ...
    plt.savefig(figure_dir+"figure{0}.png".format(t))
    plt.cla()
