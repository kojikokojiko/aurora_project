...
pattern=str(rho)+"_"+str(ave_flow)+"_"+str(static_dia)+"_"+str(v0)+"_"+str(DR)
...
ljw.params['Move'] = {"epsilon": epsilon_ab, "sigma": sigma_aa/2.0, "r_cut": sigma_ab*2**(1/6)-static_dia/2}
